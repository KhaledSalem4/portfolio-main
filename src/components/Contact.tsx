  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_name: 'Khaled Ahmed',
        to_email: 'khaledas418@gmail.com',
      ...
      toast({
        ...
        description: "شكراً لتواصلك معي. سأرد عليك في أقرب وقت.",
      });
      ...
      toast({
        ...
        description: "حدث خطأ أثناء إرسال الرسالة. يرجى المحاولة مرة أخرى أو التواصل مباشرة عبر البريد الإلكتروني.",
        variant: "destructive",
      });
    } finally {
